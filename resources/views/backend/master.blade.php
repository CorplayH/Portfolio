        ...
        <div id="vueApp" class="pt-wrapper">
            ...
            <div class="subpages">
                ...
                <section class="pt-page pt-page-1 section-with-bg section-paddings-0"
                         ...
                         data-id="home-background">
                    <a class="edit-data" @click.prevent="openModal($event)"
                       id="home-background">
                    </a>
                    {{--@include('backend.home')--}}
                        <vue-home></vue-home>
                    <div class="modal fade" id="home-background-modal" tabindex="-1" role="dialog" style="display: none;">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="col-xs-6 col-md-12 subpage-block">
                                    ...
                                    <div  style="margin-top:0px; margin-bottom: 0px; ">
                                        <button id="background" class="btn-primary col-12" name="background-button" @click.prevent="uploadImage()">Upload image</button>
